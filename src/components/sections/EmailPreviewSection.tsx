  ...
  return (
    <section className="snap-section flex items-center justify-center bg-[#e8eaed]" aria-label="이메일 예시">
      <div className="max-w-4xl mx-auto px-6 md:px-8 w-full py-10 md:py-14">
        ...
        >
          <p className="font-semibold text-[#6bb8d4] text-xs uppercase tracking-wider">Email Preview</p>
          <h2 className="font-black text-[#1e2235] text-2xl md:text-3xl">이런 보고서를 받게 돼요</h2>
